package OfficeHours.Practice._4_9;
...
public class RandomArray {
    public static void main(String[] args) {
        int[] arr=getRandomIntArray(5,50);
...
//3) Create an int array with random numbers. The number of
//    elements is based on the given number
//    Flow:
//    How many numbers do you want: 5
//    What is the max number value: 50
//            -> Print the array with 5 random numbers from 0 to 50
public static int[] getRandomIntArray(int size,int maxRandomNum){
