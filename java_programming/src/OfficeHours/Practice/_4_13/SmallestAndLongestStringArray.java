...
public class SmallestAndLongestStringArray {
...
//            System.out.println("Enter the word-"+(1+i));
//            words[i]=input.next();
...
//            }
//        }
//        System.out.println("Word " +big+" is the smollest one");
//        System.out.println("How many words will be");
//        String[]words=new String[input.nextInt()];
//        int count=0;
//        String big="";
//        for(int i =0;i<words.length;i++){
