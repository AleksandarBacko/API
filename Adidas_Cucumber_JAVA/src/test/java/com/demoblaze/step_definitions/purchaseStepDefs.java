...
public class purchaseStepDefs {
    ...
    public void under_category_user_should_see_the_list_of_products(String category, List<String> expectedProducts) {
        ...
        List<String> actualProducts=BrowserUtils.getElementsText(adidasPage.devices);
...
cartPrice=adidasPage.productRemover(products);
    ...
    public void userAddsFromToSeeThePrice(String products, String category) {
        String locator="//a[.='Samsung galaxy s6']/../../h5";
    ...
    @Then("User verify list and cart price are same and they are equal to {string}")
    public void userVerifyListAndCatrPriceAreSameAndTheyAreEqualTo(String priceString) {
